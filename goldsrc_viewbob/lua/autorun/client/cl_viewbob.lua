local cvar_enable = CreateClientConVar("gsrc_viewbob_enable", 1, true, false)

local cvar_bob = CreateClientConVar("gsrc_viewbob_bob", 0.01, true, false)
local cvar_bobcycle = CreateClientConVar("gsrc_viewbob_bobcycle", 0.8, true, false)
local cvar_bobup = CreateClientConVar("gsrc_viewbob_bobup", 0.5, true, false)

local cvar_weaponbob = CreateClientConVar("gsrc_viewbob_weaponbob", 1, true, false)

local cvar_weaponoffset = CreateClientConVar("gsrc_viewbob_weaponoffset", 2, true, false)
